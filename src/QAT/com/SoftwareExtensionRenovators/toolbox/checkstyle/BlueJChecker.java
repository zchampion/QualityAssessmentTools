...
public class BlueJChecker
{
     ...
     */
    public static com.SoftwareExtensionRenovators.toolbox.checkstyle.Auditor processAllFiles()
     ...
     * @throws CheckstyleException if there is an error.
     */
    public static com.SoftwareExtensionRenovators.toolbox.checkstyle.Auditor process(Set<File> files)
        throws CheckstyleException
    {
        ...
        final Configuration config =
            ConfigurationLoader.loadConfiguration(
                CheckstyleSettings.getConfigStream(),
                new PropertiesExpander(props),
                true);
        c.configure(config);

        final AuditListener auditor = new com.SoftwareExtensionRenovators.toolbox.checkstyle.Auditor();
    ...
    private static Properties getProperties() throws CheckstyleException {
        ...
        try {
            InputStream propStream = CheckstyleSettings.getPropertyStream();
            if (propStream != null) {
